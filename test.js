...
const { mdp } = require('./config.json')

// Step 2: Declaring new imap object
var imap = new Imap({
    user: 'arsene.raillard@etudiant.univ-lr.fr', // example: aakanksha.jain8@gmail.com
    password: mdp, // Remember, using just password for authentication will only work if you have less secured apps enabled
